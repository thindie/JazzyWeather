...
@Stable
class ConcreteCalendarState(val digits: List<Int>, val days: List<ForecastDay>)

@Composable
fun rememberCalendarState(digits: List<Int>, days: List<ForecastDay>): ConcreteCalendarState {
